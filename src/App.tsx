  ...
  return (
    <>
      ...
      <motion.main
        ...
        <div className="layout-container mb-10">
          <header
            ...
            <a
              href="#contact"
              tabIndex={0}
              className="text-sm font-medium text-center text-accent hover:text-accent-hover transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-accent rounded-full px-2 py-1">
              {t("hero.contactLink")}
            </a>
            <LangSwitcher />
          </header>
          ...
          <div>
            <motion.h2
              ...
              className="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
              Alexis Ladurelle
            </motion.h2>
            <motion.p
              ...
              className="text-center text-xl font-semibold text-accent">
              {t("hero.role")}
            </motion.p>
          </div>
          ...
          <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-4">
            ...
            <a
              href="#projects"
              className="focus:outline-none focus:ring-2 focus:ring-accent rounded-2xl border-2 border-transparent hover:border-accent/60 hover:shadow-md transition-all duration-200">
              <Card
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-2 ">
                {links.map((link, index) => (
                  <motion.a
                    ...
                    className={`flex flex-col items-center justify-center gap-2 rounded-xl p-3 bg-chip hover:bg-card transition-colors duration-200 w-full min-h-[100px] min-w-[110px] ${
                      index === 2
                    ...
                    />
                    <span className="text-xs sm:text-sm font-semibold text-body">
                      {link.name}
                    </span>
                  </motion.a>
                ))}
            ...
            <Card
              ...
              delay={0.4}
              direction="right">
              <div className="grid grid-cols-2 min-[470px]:grid-cols-3 gap-3 sm:grid-cols-3 sm:justify-items-stretch">
                {techno.map((tech) => (
                  <motion.div
                    key={tech.name}
                    className="flex flex-col items-center justify-center gap-2 rounded-xl p-3 bg-chip hover:bg-card transition-colors duration-200 w-full min-h-[100px]"
                    whileHover={{ scale: 1.04 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ duration: 0.15, ease: "easeOut" }}>
                    <img
        ...
        {/* PROJECT SECTION */}
        <section className="layout-container mt-24 pb-24" id="projects">
